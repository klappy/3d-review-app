...
export function fixture(role='owner') {
 ...
 const a={id:'a1',kind:'assessment',label:'September assessment',detail:'September · Understanding',href:'#assessment/a1/understand',visible:true,role:role==='viewer'?'Viewer':'Member',children:[survey]};
