...
// /mcp requires a credential (OAuth or a first-party bearer — src/worker.ts): an anonymous parity run has no MCP face to compare.
if (!SESS) { console.error("parity needs SESS=<bearer>: /mcp answers 401 without a credential (MCP authorization, src/oauth.ts)"); process.exit(2); }
