...
// projects page). L9-2: body is prototype frame 2 (design-system-v3 app.js card()). /v2/me carries no display name, so no "Welcome, <name>". Response counts by group are not drawn here yet (next slice) — never a number the server did not send.
