...
export function blankModel(scope, id) { return { scope, id, status: 'loading', grants: [], pending: [], me: null, myRole: null, sheet: null, notice: null, alert: false, busy: false, receipts: {} }; }
