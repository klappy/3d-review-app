...
export const MOUNTED = ['entry (tour, example, survey code, sign-in)', 'workspaces', 'one workspace (its projects)', 'projects', 'one project (assessments, languages)', 'one assessment: Prepare · Collect · Understand · Improve · Permissions', 'survey screen', 'survey counts', 'print blank survey'];
export const ELSEWHERE = { where: 'Workspaces & people (legacy)', items: ['stage change', 'survey links and codes', 'participant survey flow', 'shared links'] };
