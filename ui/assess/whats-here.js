...
export const ELSEWHERE = { where: 'Workspaces & people (legacy)', items: ['access codes and code-based participant surveys', 'invitations, role changes and ownership transfer', 'invitation acceptance'] };
