...
.rv-btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:44px;padding:10px 17px;border:1px solid var(--edge);border-radius:12px;background:rgba(255,255,255,.85);color:var(--ink);font-weight:600;cursor:pointer;text-decoration:none;box-shadow:0 2px 6px #2543630d}.rv-btn:hover{background:#fff;box-shadow:0 4px 12px #25436316}.rv-btn.primary{background:var(--green);color:#fff;border-color:transparent}.rv-btn.primary:hover{background:#10574f}
.public-choices{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:0 0 22px}.public-choices .rv-btn{white-space:nowrap}#public-about{scroll-margin-top:16px}
@media(max-width:760px){.public-choices{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.public-choices .rv-btn{white-space:normal}}
...
@media(min-width:651px){.context-disclosure{display:contents}.context-disclosure:not([open])>*:not(summary){display:revert}}
`;
