  ...
  bind(ctx, root, model) {
    ...
    root.querySelector('#email-link-form')?.addEventListener('submit', async ev => {
      ...
      try {
        ...
        if (res.type === 'opaqueredirect') { window.location.assign('/v2/auth/email'); return; } // environment without email links
