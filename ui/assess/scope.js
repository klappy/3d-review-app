...
const signupNote = ctx => `<small class="small muted signup-note" data-signup-note style="display:block;grid-column:1/-1;flex-basis:100%;margin:0">${ctx.esc(SIGNUP_NOTE)}</small>`;
