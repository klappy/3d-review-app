...
// On "/" the choices are a grid (4 columns, 2 on phones) whose last cell is Sign in: the note sits in the last column, under it.
const signupNote = (ctx, place = 'display:block;flex-basis:100%') => `<small class="small muted signup-note" data-signup-note style="${place};margin:0">${ctx.esc(SIGNUP_NOTE)}</small>`;
