...
function appHarness() {
  ...
  const context = vm.createContext({ ...resume, ...visibility, ...present, ...shared, sharedCopy: shared.copy,
    ...
    redactDiagnosticPath: u => u, createCollabHooks: () => ({ reset() {}, identity() {}, projects() {}, setScope() {}, destroy() {} }), // app.js import stripped above; hooks covered by collab-mount.test.mjs + Chromium
  });
