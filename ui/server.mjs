  ...
  if (path.startsWith('/v2/')) {
    try {
      ...
      if(response.headers.get('content-type')?.includes('text/event-stream')){
        ...
        for(;;){const {done,value}=await reader.read();if(done)break;res.write(value);}res.end();
