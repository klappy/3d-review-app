...
const files = { '/': ['index.html', 'text/html'], '/app.js': ['app.js', 'text/javascript'], '/language.js': ['language.js', 'text/javascript'], '/present.js': ['present.js', 'text/javascript'], '/visibility.js': ['visibility.js', 'text/javascript'], '/style.css': ['style.css', 'text/css'] };
