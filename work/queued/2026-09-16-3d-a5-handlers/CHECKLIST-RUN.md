# CHECKLIST-RUN — 2026-09-16-3d-a5-handlers
...
| 3 Naming | ✅ | `2026-09-16-3d-a5-handlers` — civil date of the order, America/New_York |
| 4 Ingredients bound | ✅ | pinned SHAs; prep dishes named as rail ids |
| 5 Declared product | ✅ | by path |
| 6 Done-means observable | ✅ | 6 entries, consumer/action/outcome |
| 7 Dependencies resolvable | 🔴 BLOCKED — dependencies sit in 1-ordered; ready when they plate | 2026-09-16-3d-a1-contract-freeze, 2026-09-16-3d-a2-schema, 2026-09-16-3d-a3-auth, 2026-09-16-3d-a4-policy |
